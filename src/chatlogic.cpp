...
ChatLogic::ChatLogic()
{
	...
	/* creae local Chat bot in function LoadAnswerGraphFromFile */
    /* was: _chatBot = new ChatBot("../images/chatbot.png"); */

    // // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    /* was:  _chatBot->SetChatLogicHandle(this); */
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
						...
						/* Task 3 : Exclusive Ownership 2*/
						/* replace (GraphNode *node) with (std::unique_ptr<GraphNode>& node) */
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            /* Note: parentNode and childNode are iterator */
