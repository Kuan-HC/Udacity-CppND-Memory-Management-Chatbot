...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        //// STUDENT CODE
                        ////
                        //_nodes.emplace_back(new GraphNode(id)); /* was */
                        // check if node with this ID exists already
                        //auto newNode = std::find_if(_nodes.begin(), _nodes.end(), [&id](GraphNode *node) { return node->GetID() == id; }); /* was */
    ...
    ************************************************/
    ...
    rootNode->MoveChatbotHere(std::move(l_chatBot));
